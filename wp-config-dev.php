...
//set custom setting for multi-server
...
switch (gethostname()) {
	case "ubuntu":
		...
		break;
	//server staging
		case "web579.mp.ha.ovh.net":

		define('DB_NAME', 'staginglouklouk');
		define('DB_USER', 'staginglouklouk');
		define('DB_PASSWORD', 'staginglouklouk');
